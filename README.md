...
v0: discovery across 26 agents (Claude Code, Claude Desktop, Cursor,
...
Assistant, opencode, Tabnine, Cody, Goose, Aider, OpenHands, plus a
generic Unknown Agent Mode fallback), static
...
crates/
  ...
  agentguard-adapters    per-agent discovery: Claude Code, Claude Desktop, Cursor, Codex, Windsurf/Devin Desktop, Devin CLI, Antigravity, Gemini CLI, GitHub Copilot CLI, VS Code (Copilot), OpenClaw, Amp, Kiro, Amazon Q Developer CLI, Continue.dev, Cline, Roo Code, Zed, JetBrains AI Assistant, opencode, Tabnine, Cody, Goose, Aider, OpenHands, Unknown Agent Mode
