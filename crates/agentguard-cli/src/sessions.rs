...
//! (`~/.agentguard/sessions/<date>-<pid>.jsonl`, `AGENTGUARD_SESSIONS_DIR`
//! overrides). Written by `agentguard-mcp-proxy`; surfaced by
//! `agentguard status` and `agentguard why`.
...
fn sessions_dir() -> Option<PathBuf> {
    std::env::var_os("AGENTGUARD_SESSIONS_DIR")
        .map(PathBuf::from)
