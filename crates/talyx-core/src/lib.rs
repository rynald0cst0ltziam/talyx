//! talyx-core
//!
//! Shared domain model for Talyx. Every adapter, scanner, and the risk
...
pub enum Capability {
    ...
    // Detected by talyx-scanner's content analysis (`content.rs`),
...
/// The normalized representation of anything Talyx can reason about —
