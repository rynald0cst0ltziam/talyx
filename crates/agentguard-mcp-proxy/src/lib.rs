...
pub struct ProxyConfig {
    ...
    /// tried: `$AGENTGUARD_GUARDRAILS`, `<project_dir>/.agentguard/
    /// guardrails.yaml`, `~/.agentguard/guardrails.yaml`.
    pub guardrails_path: Option<PathBuf>,
    /// Project directory, for resolving `.agentguard/guardrails.yaml`.
